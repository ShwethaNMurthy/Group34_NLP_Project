...
for root, directories, files in os.walk(r'/Users/bharathgowda/Desktop/NLP_PROJECT/ShortAnswerGrading_v2.0/data/scores'):
...
scores_given_by_lsa = create_dic_of_lsa_scores(r'/Users/bharathgowda/Desktop/NLP_PROJECT/')
...
for key in scores_given_by_lsa.keys():
    ...
    print(sem_sim1)
    '''
    if sem_sim1 >= 0.9 and sem_sim1 <= 1:
        score = 5
    elif sem_sim1 >= 0.8 and sem_sim1 < 0.9:
        score = 4.5

    elif sem_sim1 >= 0.7 and sem_sim1 < 0.8:
        score = 4

    elif sem_sim1 >= 0.6 and sem_sim1 < 0.7:
        score = 3.5

    elif sem_sim1 >= 0.5 and sem_sim1 < 0.6:
        score = 3
...
#final_accuracy = ((accuracy_count/len(scores_given_by_lsa))*100)
...
def calculate_accuracy(scores_given_by_professor, scores_scale):
    ...
    for prof_score_key in scores_given_by_professor.keys():
        #if prof_score_key in scores_given_by_lsa:
